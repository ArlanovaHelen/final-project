...
class PhonenumberFileSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        read_file_task.delay(name_file=fr"/home/lena/WorkProjectFrauds/WorkProject/num_history/{phonenumber_file.name}")
...
class FraudSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Fraud
        fields = ('id', 'numEO', 'date', 'district', 'category', 'victim', 'numERDR', 'card_number',
                  'phonenumber', 'phonenumber_location', 'phonenumber_history', 'damage', 'stage_of_crime', 'user')
