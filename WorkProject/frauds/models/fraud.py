...
class Fraud(models.Model):
    ...
    district = models.ForeignKey(District, on_delete=models.RESTRICT, related_name='frauds', null=True, blank=True)
    category = models.ForeignKey(Category, on_delete=models.RESTRICT, related_name='frauds', null=True, blank=True)
    ...
    phonenumber_location = models.FileField(upload_to='num_location/', null=True, blank=True)
    phonenumber_history = models.FileField(upload_to='num_history/', null=True, blank=True)
    damage = models.IntegerField(validators=[non_negative_validator], null=True, blank=True)
