...
from frauds.serializers import (FraudSerializer, CategoryWithFraudsSerializer, FraudViewSerializer, CategorySerializer,
                                DistrictSerializer, DistrictWithFraudsSerializer, PrisonSerializer, PhonenumberFileSerializer,
